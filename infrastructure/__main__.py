...
# The application's backend: A Django service

# Creating a target group through which the Django backend receives requests
...
# Creating a Docker image from "./backend/Dockerfile", which we will use
# to upload our app
        ...
        [
            {
                ...
                "command": ["bash", "/backend/setupDatabase.sh"],
            }
        ]
    ),
)
